...
<div id="wrapper4">
    ...
    <div id="carousel4">
        ...
        <div id="content4">
            ...
            $url = "https://api.themoviedb.org/3/discover/movie?api_key="  . $key . "&language=fr-FR&release_date.gte=" . $dateNow . "&release_date.lte=2022-12-31&region=FR https://api.themoviedb.org/3/discover/movie?api_key=" . $key . "&language=fr-FR&primary_release_date.gte=" . $dateNow . "&primary_release_date.lte=2022-12-31&region=FR";
